...
subplot(1,2,1)
y1 = cData.methodE.holyData.mEOutput_batch(61).Q(ptcList);
y2 = cData.methodE.holyData.mEOutput_batch(62).Q(ptcList);
y3 = cData.methodE.holyData.mEOutput_batch(63).Q(ptcList);
y4 = cData.methodE.holyData.mEOutput_batch(64).Q(ptcList);
y5 = cData.methodE.holyData.mEOutput_batch(65).Q(ptcList);
y6 = cData.methodE.holyData.mEOutput_batch(66).Q(ptcList);
y7 = cData.methodE.holyData.mEOutput_batch(67).Q(ptcList);
y8 = cData.methodE.holyData.mEOutput_batch(68).Q(ptcList);
y9 = cData.methodE.holyData.mEOutput_batch(69).Q(ptcList);
y10 = cData.methodE.holyData.mEOutput_batch(70).Q(ptcList);
...
subplot(1,2,2)
y1 = cData.methodE.holyData.mEOutput_batch(61).Q(ocList);
y2 = cData.methodE.holyData.mEOutput_batch(62).Q(ocList);
y3 = cData.methodE.holyData.mEOutput_batch(63).Q(ocList);
y4 = cData.methodE.holyData.mEOutput_batch(64).Q(ocList);
y5 = cData.methodE.holyData.mEOutput_batch(65).Q(ocList);
y6 = cData.methodE.holyData.mEOutput_batch(66).Q(ocList);
y7 = cData.methodE.holyData.mEOutput_batch(67).Q(ocList);
y8 = cData.methodE.holyData.mEOutput_batch(68).Q(ocList);
y9 = cData.methodE.holyData.mEOutput_batch(69).Q(ocList);
y10 = cData.methodE.holyData.mEOutput_batch(70).Q(ocList);
...
subplot(1,2,1)
y1 = cData.methodE.holyData.mEOutput_batch(71).Q(ptcList);
y2 = cData.methodE.holyData.mEOutput_batch(72).Q(ptcList);
y3 = cData.methodE.holyData.mEOutput_batch(73).Q(ptcList);
y4 = cData.methodE.holyData.mEOutput_batch(74).Q(ptcList);
y5 = cData.methodE.holyData.mEOutput_batch(75).Q(ptcList);
y6 = cData.methodE.holyData.mEOutput_batch(76).Q(ptcList);
y7 = cData.methodE.holyData.mEOutput_batch(77).Q(ptcList);
y8 = cData.methodE.holyData.mEOutput_batch(78).Q(ptcList);
y9 = cData.methodE.holyData.mEOutput_batch(79).Q(ptcList);
y10 = cData.methodE.holyData.mEOutput_batch(80).Q(ptcList);
...
subplot(1,2,2)
y1 = cData.methodE.holyData.mEOutput_batch(71).Q(ocList);
y2 = cData.methodE.holyData.mEOutput_batch(72).Q(ocList);
y3 = cData.methodE.holyData.mEOutput_batch(73).Q(ocList);
y4 = cData.methodE.holyData.mEOutput_batch(74).Q(ocList);
y5 = cData.methodE.holyData.mEOutput_batch(75).Q(ocList);
y6 = cData.methodE.holyData.mEOutput_batch(76).Q(ocList);
y7 = cData.methodE.holyData.mEOutput_batch(77).Q(ocList);
y8 = cData.methodE.holyData.mEOutput_batch(78).Q(ocList);
y9 = cData.methodE.holyData.mEOutput_batch(79).Q(ocList);
y10 = cData.methodE.holyData.mEOutput_batch(80).Q(ocList);
