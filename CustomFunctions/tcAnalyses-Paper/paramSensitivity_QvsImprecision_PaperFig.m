...
subplot(2,2,1)
y1 = cData.methodE.holyData.mEOutput_batch(81).Q(ptcList);
y2 = cData.methodE.holyData.mEOutput_batch(82).Q(ptcList);
y3 = cData.methodE.holyData.mEOutput_batch(83).Q(ptcList);
y4 = cData.methodE.holyData.mEOutput_batch(84).Q(ptcList);
y5 = cData.methodE.holyData.mEOutput_batch(85).Q(ptcList);
y6 = cData.methodE.holyData.mEOutput_batch(86).Q(ptcList);
y7 = cData.methodE.holyData.mEOutput_batch(87).Q(ptcList);
y8 = cData.methodE.holyData.mEOutput_batch(88).Q(ptcList);
y9 = cData.methodE.holyData.mEOutput_batch(89).Q(ptcList);
y10 = cData.methodE.holyData.mEOutput_batch(90).Q(ptcList);
...
subplot(2,2,2)
y1 = cData.methodE.holyData.mEOutput_batch(81).Q(ocList);
y2 = cData.methodE.holyData.mEOutput_batch(82).Q(ocList);
y3 = cData.methodE.holyData.mEOutput_batch(83).Q(ocList);
y4 = cData.methodE.holyData.mEOutput_batch(84).Q(ocList);
y5 = cData.methodE.holyData.mEOutput_batch(85).Q(ocList);
y6 = cData.methodE.holyData.mEOutput_batch(86).Q(ocList);
y7 = cData.methodE.holyData.mEOutput_batch(87).Q(ocList);
y8 = cData.methodE.holyData.mEOutput_batch(88).Q(ocList);
y9 = cData.methodE.holyData.mEOutput_batch(89).Q(ocList);
y10 = cData.methodE.holyData.mEOutput_batch(90).Q(ocList);
...
subplot(2,2,3)
y1 = cData.methodE.holyData.mEOutput_batch(91).Q(ptcList);
y2 = cData.methodE.holyData.mEOutput_batch(92).Q(ptcList);
y3 = cData.methodE.holyData.mEOutput_batch(93).Q(ptcList);
y4 = cData.methodE.holyData.mEOutput_batch(94).Q(ptcList);
y5 = cData.methodE.holyData.mEOutput_batch(95).Q(ptcList);
y6 = cData.methodE.holyData.mEOutput_batch(96).Q(ptcList);
y7 = cData.methodE.holyData.mEOutput_batch(97).Q(ptcList);
y8 = cData.methodE.holyData.mEOutput_batch(98).Q(ptcList);
y9 = cData.methodE.holyData.mEOutput_batch(99).Q(ptcList);
y10 = cData.methodE.holyData.mEOutput_batch(100).Q(ptcList);
...
subplot(2,2,4)
y1 = cData.methodE.holyData.mEOutput_batch(91).Q(ocList);
y2 = cData.methodE.holyData.mEOutput_batch(92).Q(ocList);
y3 = cData.methodE.holyData.mEOutput_batch(93).Q(ocList);
y4 = cData.methodE.holyData.mEOutput_batch(94).Q(ocList);
y5 = cData.methodE.holyData.mEOutput_batch(95).Q(ocList);
y6 = cData.methodE.holyData.mEOutput_batch(96).Q(ocList);
y7 = cData.methodE.holyData.mEOutput_batch(97).Q(ocList);
y8 = cData.methodE.holyData.mEOutput_batch(98).Q(ocList);
y9 = cData.methodE.holyData.mEOutput_batch(99).Q(ocList);
y10 = cData.methodE.holyData.mEOutput_batch(100).Q(ocList);
...
subplot(2,2,1)
y1 = cData.methodE.holyData.mEOutput_batch(191).Q(ptcList);
y2 = cData.methodE.holyData.mEOutput_batch(192).Q(ptcList);
y3 = cData.methodE.holyData.mEOutput_batch(193).Q(ptcList);
y4 = cData.methodE.holyData.mEOutput_batch(194).Q(ptcList);
y5 = cData.methodE.holyData.mEOutput_batch(195).Q(ptcList);
y6 = cData.methodE.holyData.mEOutput_batch(196).Q(ptcList);
y7 = cData.methodE.holyData.mEOutput_batch(197).Q(ptcList);
y8 = cData.methodE.holyData.mEOutput_batch(198).Q(ptcList);
y9 = cData.methodE.holyData.mEOutput_batch(199).Q(ptcList);
y10 = cData.methodE.holyData.mEOutput_batch(200).Q(ptcList);
...
subplot(2,2,2)
y1 = cData.methodE.holyData.mEOutput_batch(191).Q(ocList);
y2 = cData.methodE.holyData.mEOutput_batch(192).Q(ocList);
y3 = cData.methodE.holyData.mEOutput_batch(193).Q(ocList);
y4 = cData.methodE.holyData.mEOutput_batch(194).Q(ocList);
y5 = cData.methodE.holyData.mEOutput_batch(195).Q(ocList);
y6 = cData.methodE.holyData.mEOutput_batch(196).Q(ocList);
y7 = cData.methodE.holyData.mEOutput_batch(197).Q(ocList);
y8 = cData.methodE.holyData.mEOutput_batch(198).Q(ocList);
y9 = cData.methodE.holyData.mEOutput_batch(199).Q(ocList);
y10 = cData.methodE.holyData.mEOutput_batch(200).Q(ocList);
...
subplot(2,2,3)
y1 = cData.methodE.holyData.mEOutput_batch(201).Q(ptcList);
y2 = cData.methodE.holyData.mEOutput_batch(202).Q(ptcList);
y3 = cData.methodE.holyData.mEOutput_batch(203).Q(ptcList);
y4 = cData.methodE.holyData.mEOutput_batch(204).Q(ptcList);
y5 = cData.methodE.holyData.mEOutput_batch(205).Q(ptcList);
y6 = cData.methodE.holyData.mEOutput_batch(206).Q(ptcList);
y7 = cData.methodE.holyData.mEOutput_batch(207).Q(ptcList);
y8 = cData.methodE.holyData.mEOutput_batch(208).Q(ptcList);
y9 = cData.methodE.holyData.mEOutput_batch(209).Q(ptcList);
y10 = cData.methodE.holyData.mEOutput_batch(210).Q(ptcList);
...
subplot(2,2,4)
y1 = cData.methodE.holyData.mEOutput_batch(201).Q(ocList);
y2 = cData.methodE.holyData.mEOutput_batch(202).Q(ocList);
y3 = cData.methodE.holyData.mEOutput_batch(203).Q(ocList);
y4 = cData.methodE.holyData.mEOutput_batch(204).Q(ocList);
y5 = cData.methodE.holyData.mEOutput_batch(205).Q(ocList);
y6 = cData.methodE.holyData.mEOutput_batch(206).Q(ocList);
y7 = cData.methodE.holyData.mEOutput_batch(207).Q(ocList);
y8 = cData.methodE.holyData.mEOutput_batch(208).Q(ocList);
y9 = cData.methodE.holyData.mEOutput_batch(209).Q(ocList);
y10 = cData.methodE.holyData.mEOutput_batch(210).Q(ocList);
