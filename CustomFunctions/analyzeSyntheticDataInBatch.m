...
function [mAOutput_batch, mBOutput_batch, mCOutput_batch, mDOutput_batch, mEOutput_batch] = analyzeSyntheticDataInBatch(sdcpStart, sdcpEnd, runA, runB, runC, runD, runE)
