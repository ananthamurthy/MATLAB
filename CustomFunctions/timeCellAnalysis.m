...
for iexp = 1:length(db)
    ...
    if ops0.findTimeCells
        ...
        freqThreshold = floor(0.25 * (size(myData,2))); %freqThreshold is 25% of the session trials
        ...
        if ops0.method == 'A' %No filtering for % of trials active
            ...
            [timeLockedCells, TI] = getTimeLockedCells(PSTH_3D, allCells, nShuffles, shuffleThreshold, delta);
        ...
        elseif ops0.method == 'B' %PSTH then filtering for % of trials active
            ...
            [PSTH, PSTH_3D, nbins] = getPSTH(myData, delta, skipFrames);
            [timeLockedCells_temp, TI] = getTimeLockedCells(PSTH_3D, allCells, nShuffles, shuffleThreshold);
    ...
    if ops0.findTimeCells
        ...
        if ops0.useLOTO
            if ops0.multiDayAnalysis
                ...
                if ops0.loadSyntheticData == 1
                    save([saveFolder db(iexp).mouse_name '_' db(iexp).date '_' ops0.method '_synth' num2str(ops0.loadSyntheticData) '_multiDay.mat' ], ...
                ...
                if ops0.loadSyntheticData == 1
                    save([saveFolder db(iexp).mouse_name '_' db(iexp).date '_' ops0.method '_synth' num2str(ops0.loadSyntheticData) '.mat' ], ...
                        'dfbf', 'baselines', 'dfbf_2D', ...
                        'dfbf_timeLockedCells', ...
                        'dfbf_sorted_timeLockedCells', ...
                        'trialPhase', 'window', ...
