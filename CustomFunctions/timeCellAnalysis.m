    ...
    if ops0.findTimeCells
        ...
        if ops0.useLOTO
            if ops0.multiDayAnalysis
                ...
                if ops0.loadSyntheticData == 1
                    save([saveFolder db(iexp).mouse_name '_' db(iexp).date  '_synth' num2str(ops0.loadSyntheticData) '_multiDay.mat' ], ...
                ...
                if ops0.loadSyntheticData == 1
                    save([saveFolder db(iexp).mouse_name '_' db(iexp).date '_synth' num2str(ops0.loadSyntheticData) '.mat' ], ...
                        'dfbf', 'baselines', 'dfbf_2D', ...
                        'dfbf_timeLockedCells', ...
                        'dfbf_sorted_timeLockedCells', ...
                        'trialPhase', 'window', ...
...
if ops0.findTimeCells
    if ops0.fig
        ...
        %         title('Trends in Temporal Information'), ...
        %             'FontSize', figureDetails.fontSize, ...
        %             'FontWeight', 'bold')
